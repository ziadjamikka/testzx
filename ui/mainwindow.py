...
class MainWindow(FramelessWindow):
    ...
    def __init__(self, app: QApplication, config: ProgramConfig, open_dir='', *args, **kwargs) -> None:
        ...
        # بعد إنشاء self.st_manager و self.textPanel.formatpanel
        # ربط إشارة Apply من StyleListPanel
        try:
            stylelist_panel = self.textPanel.formatpanel.style_list_panel
            stylelist_panel.style_applied.connect(self.apply_style_to_selected_text)
        except Exception as e:
            pass  # إذا لم تكن موجودة، تجاهل
    ...
    def apply_style_to_selected_text(self, fontfmt):
        # fontfmt هو FontFormat مباشرة
        self.st_manager.apply_fontformat(fontfmt)