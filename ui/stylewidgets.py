...
class ImgtransProgressMessageBox(ProgressMessageBox):
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.remake_bar = TaskProgressBar(self.tr('Remake: '), self)
        ...
        layout.addWidget(self.remake_bar)
    ...
    def updateRemakeProgress(self, value: int, msg: str = ''):
        self.remake_bar.updateProgress(value, msg)
